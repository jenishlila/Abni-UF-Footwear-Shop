                                ...
                                <table id="datatable" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <a type="submit" id="demo-btn-addrow" class="btn btn-primary" href="{{url('admin/size/restore',$trash->id)}}" >Restore</a>
                                                <a type="submit" id="demo-btn-addrow" class="btn btn-danger" href="{{url('admin/size/destroy',$trash->id)}}" >Delete</a>
