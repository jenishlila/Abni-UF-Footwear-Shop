...
<div class="woocommerce">
    <div class="container">
        ...
        <form name="checkout" method="post" class="checkout woocommerce-checkout form-in-checkout" action="{{url('product/billupdatesave')}}" id="address" enctype="multipart/form-data">
            @csrf
            <ul class="row">
                <li class="col-md-9">
