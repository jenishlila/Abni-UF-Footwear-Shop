        ...
        <div class="container">
            ...
            <div class="checkout-step-process">
                <ul>
                    ...
                    <li>
                        <div class="step-process-item"><i data-href="checkout-step2.html"  class="redirectjs  step-icon icon-pointer"></i><span class="text">shipping</span></div>
                    </li>
                    {{-- <li>
            ...
            <form name="checkout" method="post" class="checkout woocommerce-checkout form-in-checkout" action="{{url('product/store')}}" id="address" enctype="multipart/form-data">
                @csrf
                <ul class="row">
                    <li class="col-md-9">
                            ...
                            <li class="col-md-12">
                                ...
                                <ul>
                                    ...
                                    @foreach ($baddress as $baddress)
                                        <li class="col-md-4">
                                        <input type="radio" class="availabledata" name="data" id="{{$baddress->id}}" value="{{$baddress->id}}"><label for="rs1">Billing Address</label></span>
                                                <p><strong>{{$baddress->name}}</strong><br>
                                                {{$baddress->address}}, {{$baddress->city}}<br>
                                                {{$baddress->state}}, {{$baddress->pincode}}<br>
                                                {{$baddress->email}}<br>
                                                +91 {{$baddress->mobile}}<br>
                                            </p>
                                            
                                        </li>
                                        @endforeach
                                        <input type="radio" class="add" name="data" value=""><b>ADD NEW </b>
                            ...
                            <!--dnone block -->
                                <ul class="row main" style="margin-top: 20px;">
                                    <li class="col-md-12">
                                        ...
                                        <input type="text" class="input-text " name="name" id="name" placeholder="" value="{{Auth::user()->name}}">
                                        @error('name')
                                    ...
                                    <p class="form-row  validate-required validate-email" id="billing_email_field">
                                        ...
                                        <input type="text" class="input-text " name="email" id="billing_email" placeholder="" value="{{Auth::user()->email}}">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong class="text-danger">{{ $message }}</strong>
                                        </span>
                                ...
                                <li class="col-md-6">
                                    <p class="form-row validate-required validate-phone woocommerce-validated" id="mobile">
                                        ...
                                        <input type="text" class="input-text " name="mobile" id="mobile" placeholder="" value="{{Auth::user()->mobile}}">
                                    @error('mobile')
                                        <span class="invalid-feedback" role="alert">
                                            <strong class="text-danger">{{ $message }}</strong>
                                        </span>
